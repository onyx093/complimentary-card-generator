...
// import TemplateGallery from "@/components/dashboard/TemplateGallary";
...
//           {/* Right: single card containing Templates (top) and Quick Preview (bottom) - 60% on lg */}
...
import { TemplateId } from "@/lib/types/cardTemplate";
